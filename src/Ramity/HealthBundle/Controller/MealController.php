...
use Ramity\HealthBundle\Entity\Meal;
...
class MealController extends Controller
{
    ...
    {
        $meal = new Meal();
        $form = $this->createForm('Ramity\HealthBundle\Form\MealType', $meal);
    ...
    {
        $deleteForm = $this->createDeleteForm($meal);
        $editForm = $this->createForm('Ramity\HealthBundle\Form\MealType', $meal);
